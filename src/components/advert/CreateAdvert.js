...
class CreateAdvert extends Component {
  ...
  handleSubmit = async (e) => {
    e.preventDefault();
    if (!cookies.get('account') || !cookies.get('account')) {
      return alert('login to wallet First');
    }
    const data = await axios.post('https://kanda-api.herokuapp.com/advert', {
          ...
          <form onSubmit={this.handleSubmit} className='create-advert'>
            <div className='green-advert'>
              ...
              <div className='image-field'>
                <label htmlFor='imageFile' className='include-image'>
